...
public class MaterialSharpIconSetBuilder : IconSetFileBuilder
{
    ...
    public override string OutputFilename { get; init; } = "Sharp";
    private string InputFileName { get; init; } = "sharp";
