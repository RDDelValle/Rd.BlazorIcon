...
public class MaterialBaselineIconSetBuilder : IconSetFileBuilder
{
    ...
    public override string OutputFilename { get; init; } = "Baseline";
    private string InputFileName { get; init; } = "baseline";
