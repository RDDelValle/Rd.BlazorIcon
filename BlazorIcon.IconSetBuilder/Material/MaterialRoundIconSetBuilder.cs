...
public class MaterialRoundIconSetBuilder : IconSetFileBuilder
{
    ...
    public override string OutputFilename { get; init; } = "Round";
    private string InputFileName { get; init; } = "round";
